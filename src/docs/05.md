...
翻译成<q>...have yet to (begin) [verb](ing)</q>，例如<q>I’ve yet to meet him</q>（我还没有见到他）、<q>She has yet to begin dancing</q>（她还没有开始跳舞）。请注意，由于英语/汉语的特殊性，<abbr>ATP</abbr> 时体的使用有时可以翻译成否定性句子，如以下示例的不同翻译所示：
