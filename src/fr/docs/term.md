...
@tab Formation des mots

* morphe : morph
* morphème : morpheme
* racine : root
  * Racine de Transporteur : Carrier Root
  * Racines Spécialisées de `Cs` : Specialized Cs-Roots
  * Racines Référentielles Spécialisées : Specialized Referential Roots
* Thème : Stems
  * Thème 1 : Stem 1
  * Thème 2 : Stem 2
  * Thème 3 : Stem 3
...
* Affixes : Affixes
  * Degrés : Degrees
  * Type de Gradient : Gradient-Type
  * Type d’Affixe : Affix Type
    * Affixe de Type 1 : Type-1 Affix
    * Affixe de Type 2 : Type-2 Affix
    * Affixe de Type 3 : Type-3 Affix
* Emplacement : Slot
* Concaténation : Concatenation
  * Type de Concaténation :  Concatenation Type
  * Paire concaténée : Concatenated Pair
  * Chaîne concaténée : Concatenation/Concatenated Chain
  * État de Concaténation : Concatenation Status
    * Concaténation Nulle : No Concatenation
    * Concaténation de Type 1 :Type-1 Concatenation
    * Concaténation de Type 2 :Type-2 Concatenation
* [formatif] non concaténé : unconcatenated
* [formatif] concaténé : concatenated
* formatif concaténé : concatenated formative
  * Formatif concaténé de Type 1 : Type-1 concatenated formative
  * Formatif concaténé de Type 2 : Type-2 concatenated formative

* [affixe] circonstanciel : circumstantial
* [affixe] dérivationnel : derivational
* [affixe] limité : limited
* [affixe]-valise : portmanteau
* catégorie : category
* formation : formation
* affixe-complexe : affix-complex
* [affixe] descriptif : descriptive

* raccourci : shortcut

* typologie : typology
* langue agglutinante : agglutinative language
* langue synthétique : synthetic language
* thème morpho-sémantique : morpho-semantic stem
* flexion : inflection
* dérivation [lexicale] : derivation
* structure des mots : word structure
* emplacement : slot
* affixe : affix
* Séquence standard de formes vocaliques : Standard Vowel-Form Sequence
* mémorisation : memorization
* tableau : chart
* matrice : matrix
* diphtongue : diphthong
* conjointe dissyllabique [de voyelles] : disyllabic conjunct
* conjointe bivocalique : bivocalic conjunct
* [forme] phonotactiquement interdite : phonotactically impermissible
* [forme] sonore euphoniquement indésirable : euphonically undesirable
* structure morphologique : morphological structure
* inversion [de forme] : reversal
...
* Affiliation Consolidative <abbr>CSL</abbr> Consolidative Affiliation
...
* Cas Spatio-Temporels : Spatio-Temporal Cases
  ...
  * Cas Ablatif <abbr>ABL</abbr> Ablative Case
