...
<div class="indent">
    ...
    <dl class="gloss">
      ...
      <dd>词干.2/CPT-“approach”-<ins>DYN-RPV-</ins>OBG₁/1-<del>POT</del><ins>OBS</ins></dd>
    </dl>
    <dl class="gloss">
      <dt>kaʼi</dt>
      <dd>pa/BEN-ACT</dd>
...
::: tip 译者补充 💡 语义范围与简替形式说明

注意本句中的 wairţtuʼzwu。若不加声门塞音（原作 *wairţtuzwu*），<abbr>IND</abbr>格辅词缀会应用于类聚界<abbr>G</abbr>，语义会变成「某个进行一些学习的人」。为了精确表达「学生们（至少一个学习者）」，在此形式加入了声门塞音（ʼ）。此简替形式能有效翻转列位 V 词缀与格接尾词的语义层级，使类聚界正确应用在该格辅词缀上。
