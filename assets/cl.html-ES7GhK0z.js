import{_ as c,a as m}from"./spacetimedark-chCP_MRT.js";import{_ as u}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as s,o as g,c as p,a as e,d as t,b as o,w as n,e as f,f as l}from"./app-gyFXkyxF.js";const y="/assets/cl1-rdi6N7is.png",b="/assets/cl2-87NpYuff.png",w="/assets/cl3-AYsAPY_A.png",v="/assets/cl4-pTzw22t2.png",k="/assets/cl5-OZ-WCNm7.png",x={},I=l('<p>Yueh LIN 所作，L. C. D. 所译。</p><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2><h3 id="语言是否塑造人类所想" tabindex="-1"><a class="header-anchor" href="#语言是否塑造人类所想" aria-hidden="true">#</a> 语言是否塑造人类所想？</h3><p>全世界有 7000 多种语言，每种语言都有其独特的声音、单词和结构。一些研究人员提出，<span style="text-decoration:underline;">人类使用的语言在塑造人类认知过程中发挥着作用</span>。例如，认知科学家 Lera Boroditsky 在 TED 演讲中强调了 Kuuk Thaayorre 人<small class="parnt">澳大利亚原住民</small>的独特语言。在这种语言中，方向的表达方式不同——它们不使用「左」和「右」等术语，而是依赖北、南、东、西等基本方向。这会产生诸如「你的西南腿上有一只蚂蚁」或「将你的杯子向东北偏北移动一点」之类的句子。有趣的是，Kuuk Thaayorre 语中的「你好」相当于「你要去哪条路？」，而回应将涉及指定方向，例如「远处的东北向。你呢？」</p><p>这种独特的语言方法可以快速确定发话者的方向，因为即使是简单的问候也需要了解自己的方向。令人惊讶的是，说这种语言的人表现出非凡的空间定向能力。与早期认为人类因生物因素而受到限制的观点相反，语言和文化显然在这项技能中发挥着重要作用。世界各地的不同人群表现出卓越的空间定向能力。</p><p>语言在词汇中对概念进行分组的方法有所不同。一种语言中的单个术语可能对应于另一种语言中的多个术语。<span style="text-decoration:underline;">语言表达概念所需的不同细节水平突显了语言结构如何塑造我们对细节的关注</span>，并影响有意义的沟通的构建。例如，英语中，短语<q>I have a cousin</q>就足够了，而在法语中，必须指定堂表手足的性别：<q>Jʼai un cousin</q>或<q>Jʼai une cousine</q>，不留任何含糊的余地。同样，普通话要求明确提及堂表手足相对于发话者的年龄以及其为父系抑或母系，不留任何含糊之处。因此，普通话要求发话者更加注重细节，因为没有这些具体而言，构建一个连贯的单词或句子变得不可能。</p><p>Ithkuil 的出现是为了检验这一假设，将许多微妙的含义融入到单词的构造中。在英语和大多数印欧语言中，复数标记可用于标记名词的数字，而 Ithkuil 可以标记数量、意图、视界等等。例如，通过使用词根 -lḍ-，可以构造这些词：alḑal<small class="parnt">一棵树</small>、alḑak<small class="parnt">森林，字面上是一组相连相似的树木，具有中性意图</small>，alḑalk<small class="parnt">园林，字面上是一组相连的相似树木，具有独特意图</small>、alḑařža<small class="parnt">丛林，字面意思是一群模糊相似的相互连接的树木，具有各种意图</small>。与英语的词形变化仅限于复数标记 -s 相比，Ithkuil 允许发话者通过以紧凑​​的形式并入更多信息来标记更多细节。</p><h3 id="目标" tabindex="-1"><a class="header-anchor" href="#目标" aria-hidden="true">#</a> 目标</h3><p>这些课程的目标是<span style="text-decoration:underline;">提供 Ithkuil 语言的分步指南，特别是对于没有语言学背景的学习者</span>或具有英语所缺乏的语言特征的经验。这些课程的安排是基于英语母语者眼中的难点。</p><p>就像任何语言的语言教科书一样，这些课程不会一次性介绍所有时态和复杂的语法特征。相反，他们会从问候、自我介绍、谈论家庭成员、讨论时间开始。虽然同时讨论某些复杂的语法特征似乎是合乎逻辑的<small class="parnt">例如英语时态的交叉比较或不规则动词变形的完整表</small>，但从教育的角度来看，按以下顺序介绍这些特征更有意义，无论是对话的重要性还是难度。</p><p>由于 Ithkuil 的复杂性和与现有自然语言的差异，通过使用理论构建词类的自下而上的方法来达到流利使用 Ithkuil 的程度是具有挑战性的。在以会话方式学习外语时，通常会通过记住有用的日常句子来接触尚未完全理解的语法点。只有当学习者熟悉了基本对话并掌握了足够的语法知识后，他们才会开始重新分析他们一直在记住的句子。这类似于法语学习者最初可能会记住并使用<q>je vous en prie</q>这句话来表示「不客气」，尽管底层语法比前几课中教授的内容更高级。</p><p>在本对话指南中，将采取自上而下的方法。即将介绍一些最初可能无法完全解释的 Ithkuil 单词和语法点，<span style="text-decoration:underline;">通过沉浸在现实的文本示例中</span>以及模拟对话，<span style="text-decoration:underline;">让读者能够理解</span>语言的结构。这种方法反映了学习者如何自然地参与语言使用并逐渐揭露其复杂性。</p><p>每节课涵盖了：</p><ul><li>一个<b>主题</b>，如学校生活、家庭生活、友谊、医疗预约、旅行。</li><li>一些非语法学习<b>目标</b>，如有能力自我介绍、有能力询问方向。</li><li>一些<b>词根</b>，每个都能够通过词干和详述范畴来派生大量词汇以构词</li><li>一些<b>词缀</b>，每个都能够与词根或构形词交互，以在词汇上叠加微妙的含义</li><li>一个或更多<b>格范畴</b>，旨在介绍和交叉比较相似但不同的格</li><li>一些<b>语法概念</b>，无论是通用的还是认知的，抑或 Ithkuil 特有的。</li><li><b>练习</b>。</li></ul><p>为提供渐进而可学习的体验，列出学习 Ithkuil 过程中要涵盖的重要知识点非常重要。主要受「New Ithkuil 语法」启发的知识点顺序可以在附录1中找到。</p><p>基本课程未涵盖的概念：</p><ul><li>格范畴</li><li>简替</li><li>更多语为·语式</li><li>时体小词</li><li>构形</li><li>系属</li><li>观感</li></ul><p>中级课程未涵盖的概念：</p><ul><li>话题、评论、焦点</li><li>格叠加</li><li>联接</li></ul><table><thead><tr><th>课程</th><th>主题</th><th>目标</th><th>词根</th><th>格</th><th>词缀</th><th>语法概念</th></tr></thead><tbody><tr><td>Wattáu. (你好)</td><td>社交生活</td><td>招呼用语<br>询问是否</td><td>-tt-<br>-gḑ-<br>-my-<br>-ttr-</td><td>AFF (用而缺解释)</td><td>-g 程度</td><td>黏着构词法及以下概念： 列位<br>词缀<br>语为</td></tr><tr><td>Wadnéu si asal Bill?</td><td>社交生活</td><td>正式招呼<br>询问名字<br>回答是否</td><td>msk<br>nn<br>t<br>dn<br>s<br>ļgw</td><td>THM<br>ERG<br>IND<br>DAT<br>(用而缺解释)</td><td>-čř 肯定<br>-r 否定</td><td>词根、详述<br>指代词<small class="parnt">介绍</small><br>载词<br>否定</td></tr><tr><td></td><td></td><td></td><td></td><td></td><td></td><td>格<br>指代词</td></tr><tr><td></td><td>社交生活</td><td>询问个人信息</td><td></td><td>位格</td><td></td><td></td></tr><tr><td></td><td>家庭</td><td>询问家庭成员</td><td>(人物词根派生多个术语)</td><td>生有格</td><td></td><td></td></tr><tr><td></td><td>家庭</td><td></td><td></td><td></td><td></td><td></td></tr></tbody></table><h3 id="关于书写系统" tabindex="-1"><a class="header-anchor" href="#关于书写系统" aria-hidden="true">#</a> 关于书写系统</h3><p>New Ithkuil 的原生书写系统是该语言所独有的，它既不是全音素文字，也不是音节文字，更不是表意文字，而是形态音位文字，也就是说，用于显示书面语言的图形字符同时传达了语音和形态<small class="parnt">即语法</small>信息，读者可以根据语言语法知识构建所要表达的词语。</p><blockquote><p>下面这个简单粗暴的罗马字母类比可以说明这一形态音位原则：假设英语中动词go的过去时书写形式是<q>gø</q>读作<q>went</q>，元音字母上的斜杠表示从现在时到过去时的切换。这就是形态音位文字的一个例子，其中的字符传达了任何无法预测的语音信息，但可预测的形式例如，英语使用者知道<q>gø</q>的过去时形式是<q>went</q>是通过符号或图形修饰传达的，只表示预期的形态变化例如，将动词变为过去时，而没有任何图形表示所产生的单词本身的语音。<sup class="footnote-ref"><a href="#footnote1">[1]</a><a class="footnote-anchor" id="footnote-ref1"></a></sup></p></blockquote><p>由于真正的 Ithkuil 书写系统的词汇形态性质，可以说 Ithkuil 的书面形式和口头形式是两种不同但高度相关的语言。这两种形式不完全双射的原因部分<small class="parnt">如果不是仅仅</small>由于所谓的「简替」形式的存在，其中相同的屈折信息可以在给定某些条件的情况下<small class="parnt">通常当某些列位为默认值时</small>更紧凑地打包音值。</p><p>作为创建 Ithkuil 会话课程的第一次尝试，我们选择忽略书面文字，而仅研究罗马化形式。请充分意识到<span style="text-decoration:underline;">罗马化形式并不是 Ithkuil 真正文字，但将其用作易于学习的工具</span>，得而更有可能促进课程设计。在未来，可以完全使用 Ithkuil 原生文字设计课程，以获得更真实的沉浸式学习体验。</p><h3 id="关于词汇和形态" tabindex="-1"><a class="header-anchor" href="#关于词汇和形态" aria-hidden="true">#</a> 关于词汇和形态</h3><p>单词的形态推导通常仍然被认为是同一个单词。<small class="parnt">英语词典通常将<q>apples</q>视为<q>apple</q>的复数形式，而不将其视为不同的单词</small>但<b>在高度依赖形态变化的语言中，经过了大量形态变化的单词可能看起来截然不同</b>而功能上仍然保持不变。</p><p>出于学习此类语言的目的，首先将这些推导词视为「不同的单词」并非闻所未闻，随着学习者熟悉形态，将逐渐将它们视为同一个单词。例如，一些日语初学者教科书将「書く」<small class="parnt">写</small>、「書きます」<small class="parnt">书写，礼貌语</small>、「書かない」<small class="parnt">不写</small>、「書きません」<small class="parnt">不写，礼貌语</small>作为不同的单词，列在词汇中部分。随着课程的进行，只有字典形「书く」<small class="parnt">写</small>才会进入词汇表，如果学习者熟悉词法规则，则可以确定其他形式。</p><p>在这些课程中，将使用类似的策略——<span style="text-decoration:underline;">形态推导被认为是不同的词汇，直到特征被很好地确立以便学习者熟悉它们为止。</span></p><h3 id="避免直译" tabindex="-1"><a class="header-anchor" href="#避免直译" aria-hidden="true">#</a> 避免直译</h3><p>同样，<span style="text-decoration:underline;">学习者应该意识到 Ithkuil 单词和英语单词之间的关系不是一对一的</span>。一般来说，与英语相对僵化的词汇相比，Ithkuil 能够以其灵活的形态表达更多的细节。可类比日语的「書く」<small class="parnt">写</small>和「書きます」<small class="parnt">写，礼貌语</small>都翻译为<q>to write</q>。这并不意味着相反，<q>to write</q>只能翻译为「書く」，因为日语使用者在使用这个词之前需要考虑礼貌，而英语则没有区别。</p><p>此外，<span style="text-decoration:underline;">Ithkuil 要求发话者表达他们真正的意思</span>。许多习语在词汇层面上没有意义，但在自然语言的语用层面上却有意义。例如，当有人打喷嚏时，讲英语的人会说<q>God bless you</q><small class="parnt">上帝保佑你</small>。技术上可以将这句话字面翻译成 Ithkuil 合乎语法的句子，但它的意思是「我希望拥有神力的实体能够为了你的福祉而发言」。这真的是你想要传达的字面意思吗？更有可能的是，这只是出于文化习惯，隐含的信息是「出于我周围文化中建立的礼貌，我觉得有必要这么说，这样人们就不会因为我不关心你的福祉而评判我」，否则我们可以说「你还好吗？」或「你觉得冷吗？需要我帮你关窗吗？」顺便说一句，并非所有语言都以相同的方式表达「上帝保佑你」。在这种情况下，西班牙语使用者会说<q>Salud</q><small class="parnt">健康</small>，而普通话使用者甚至没有表达此目的的表达方式<small class="parnt">可以用「你还好吗？」这样的句子来代替</small></p><p>另一个例子可以是对<q>sorry</q><small class="parnt">抱歉</small>的使用。根据剑桥词典，它可以「用于表示使用者希望自己没有做过其已经做过的事情，尤其是当其想向因其所做所为而利益受损的人表示礼貌时」。但它也可以「用于礼貌地拒绝某事或表示不同意时」，例如「对不起，我不能和您一起去」。</p><p><span style="text-decoration:underline;">学习者应该意识到以认知方式进行翻译，区分碰巧被同一个词标记的事物，并且只有当人们真正表达他们所说的意思时才进行翻译。</span>可以应用释义策略来更好地塑造我们的思想，例如<q>God bless you</q>，发话者并不打算传达字面意思，而是出于文化习惯而隐含信息。</p><h3 id="针对人造语言的学习策略" tabindex="-1"><a class="header-anchor" href="#针对人造语言的学习策略" aria-hidden="true">#</a> 针对人造语言的学习策略</h3>',35),_=e("q",null,"I am a student",-1),A=e("small",{class:"parnt"},"我是一名学生",-1),S=e("q",null,"Mi estas studento",-1),B=e("small",{class:"parnt"},"不需要不定冠词",-1),N=l('<h3 id="约定" tabindex="-1"><a class="header-anchor" href="#约定" aria-hidden="true">#</a> 约定</h3><p>由于 Ithkuil 是一种语法复杂的语言，不可避免地会有讲解中尚未介绍的概念。为了在引入新概念的速度和语法构建块的需要之间取得平衡，给出的解释将区分<b>已经介绍过的概念</b><small class="parnt">正常标记</small>和<b>那些尚未介绍的</b><small class="parnt">以灰色标记</small>。</p><p>通过这种身临其境的方式，读者受邀<span style="text-decoration:underline;">专注于课程的主要知识点，如果可能的话，将尚未引入的概念留作「需体会」的内容</span>，或者将其视为一个单词/句子，一旦进一步获得语法概念就可以消化。</p><h2 id="预备课-音系和罗马字" tabindex="-1"><a class="header-anchor" href="#预备课-音系和罗马字" aria-hidden="true">#</a> 预备课：音系和罗马字</h2><p>请参考<a href="../doc/01">音系</a></p><h3 id="重读-–-音系" tabindex="-1"><a class="header-anchor" href="#重读-–-音系" aria-hidden="true">#</a> 重读 – 音系</h3><p>该语言采用音高重读系统作为划分单词边界的手段。以下是该音高重读系统的详细规则：</p><ol><li><p>单词中重读音节之前的所有非重读音节采用中性音高<small class="parnt">中平调</small>。从重读音节开始，单词的剩余部分必须采用单一的非中平调的音高轮廓，如规则 2 所述。</p></li><li><p>单词从重读音节开始，发话者可以自由选择以下任何一种音高轮廓：降调、高平调、升降调和降升调。在以下情况下，还可以使用其他音高轮廓：</p><ul><li><p>如果句子具有<b>确认语为</b><small class="parnt">相当于是 / 否问题</small>，发话者可以选择在疑问子句的最后一个词上使用升调音高。</p></li><li><p>对于具有非<b>叙事域</b>的子句，可以选择在言域子句的第一个及最后一个词上使用低音调<small class="parnt">这种情况下不需要使用域尾小词</small>。</p></li></ul></li></ol><figure><img src="'+y+'" alt="stressed syllable = 重读音节；pitch = 音高；time = 时间；words start with mid-tone = 词以中平调开始；a distinct pitch contour = 独特音高轮廓；words end with non-mid-tone = 词以非中平调结束" tabindex="0" loading="lazy"><figcaption>stressed syllable = 重读音节；<br>pitch = 音高；time = 时间；<br>words start with mid-tone = 词以中平调开始；<br>a distinct pitch contour = 独特音高轮廓；<br>words end with non-mid-tone = 词以非中平调结束</figcaption></figure><figure><img src="'+b+'" alt="词以另一种非中平调结束" tabindex="0" loading="lazy"><figcaption>词以另一种非中平调结束</figcaption></figure><figure><img src="'+w+'" alt="如果句子使用了确认语为，最后一个词可选用升调" tabindex="0" loading="lazy"><figcaption>如果句子使用了确认语为，最后一个词可选用升调</figcaption></figure><p>通常情况下，音高的选择可以与发话者在自己的母语中自然使用的音高相匹配，但必须遵守这些规则。</p><ol start="3"><li><p>一旦为重读音节选择了音高，它必须连续保持到单词的末尾，不能变成不同的音高轮廓<small class="parnt">即，每个单词只能有一个非中平调音高轮廓</small>。</p></li><li><p>如果一个单词具有词首重读<small class="parnt">即，它不以中平调开始</small>或者是单音节词，并且不位于一个呼吸群的开头，那么它的音高起始音调必须与前一个词的最后一个音调不同，以避免在两个单词之间的边界处出现两个相同的音调。实际上，在同一个呼吸群中的两个相邻单词之间<small class="parnt">即它们之间没有语音停顿</small>，如果第二个单词具有词首重读或者是单音节词，则适用以下规则：</p><ul><li>当它前面是一个具有降调、升降调或低音调的单词时，单音节词或者具有词首重读的单词必须具有降调、降升调或高平调。</li><li>当它前面是一个具有高平调、升调或降升调的单词时，单音节词或者具有词首重读的单词必须具有升调、升降调或低音调。</li></ul></li></ol><figure><img src="'+v+'" alt="重读音节低音结尾而后续的重读音节高音开头，可行的超音段结构" tabindex="0" loading="lazy"><figcaption>重读音节低音结尾而后续的重读音节高音开头，可行的超音段结构</figcaption></figure><figure><img src="'+k+'" alt="重读音节低音结尾而后续的重读音节低音开头，会产生混淆，故是有问题的超音段结构" tabindex="0" loading="lazy"><figcaption>重读音节低音结尾而后续的重读音节低音开头，会产生混淆，故是有问题的超音段结构</figcaption></figure><h2 id="第一课-wattau" tabindex="-1"><a class="header-anchor" href="#第一课-wattau" aria-hidden="true">#</a> 第一课：Wattáu.</h2><h3 id="本课目标" tabindex="-1"><a class="header-anchor" href="#本课目标" aria-hidden="true">#</a> 本课目标</h3><ul><li>知晓如何用 Ithkuil 问好·道谢·道别</li><li>介绍「列位」的概念</li><li>知晓如何使用观察语为、宣示语为、确认语为</li></ul><h3 id="对话" tabindex="-1"><a class="header-anchor" href="#对话" aria-hidden="true">#</a> 对话</h3>',19),T=e("p",null,"A: Wattáu.",-1),C=e("p",null,"B: Wattáu.",-1),E=e("p",null,"A: Yagḑéu si?",-1),j=e("p",null,"B: Yagḑá li. Wamyáu. Yagḑéu si?",-1),V=e("p",null,"A: Yagḑögá. Wamyogáu.",-1),P=e("p",null,"B: Wattráu.",-1),D=e("p",null,"A: Wattráu.",-1),q=e("p",null,"A: 你好。",-1),W=e("p",null,"B: 你好。",-1),F=e("p",null,"A: 你好吗？",-1),M=e("p",null,"B: 我很好。感谢。你好吗？",-1),O=e("p",null,"A: 挺好。非常感谢。",-1),R=e("p",null,"B: 拜拜。",-1),L=e("p",null,"A: 拜拜。",-1),X=e("h3",{id:"词汇",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#词汇","aria-hidden":"true"},"#"),t(" 词汇")],-1),H=e("p",null,"尚未介绍的语法被标记为灰色的。本课语法标记为蓝色的。",-1),Q=e("dl",null,[e("dt",null,"Ithkuil 单词"),e("dd",null,"wattáu"),e("dd",null,[e("span",{class:"gray"},"ttaláu")]),e("dd",null,[e("span",{class:"gray"},"attalaháu")])],-1),z=e("dl",null,[e("dt",null,"词类"),e("dd",null,"动词性构形词")],-1),Y=e("dl",null,[e("dt",null,"含义"),e("dd",null,"嗨、嘿、你好")],-1),U=e("dl",null,[e("dt",null,"注解 \\ 完整注解"),e("dd",null,[e("span",{class:"gray"},"S1"),t("-“问候”-"),e("span",{class:"blue"},"DEC")]),e("dd",null,[e("span",{class:"gray"},"词干一"),t("-“~”-"),e("span",{class:"blue"},"宣示语为")])],-1),G=e("dl",null,[e("dt",null,"Ithkuil 单词"),e("dd",null,"yagḑéu"),e("dd",null,[e("span",{class:"gray"},"gḑadéu")]),e("dd",null,[e("span",{class:"gray"},"agḑadahéu")])],-1),J=e("dl",null,[e("dt",null,"词类"),e("dd",null,"动词性构形词")],-1),K=e("dl",null,[e("dt",null,"含义"),e("dd",null,"感觉好吗？")],-1),Z=e("dl",null,[e("dt",null,"注解 \\ 完整注解"),e("dd",null,[e("span",{class:"gray"},"S1.PRX"),t("-“感觉良好”-"),e("span",{class:"blue"},"VRF")]),e("dd",null,[e("span",{class:"gray"},"词干一.近限域"),t("-“~”-"),e("span",{class:"blue"},"确认语为")])],-1),$=e("dl",null,[e("dt",null,"Ithkuil 单词"),e("dd",null,"si")],-1),ee=e("dl",null,[e("dt",null,"词类"),e("dd",null,"指代词")],-1),te=e("dl",null,[e("dt",null,"含义"),e("dd",null,[t("你"),e("small",{class:"parnt"},"体验状态时使用")])],-1),ne=e("dl",null,[e("dt",null,"注解 \\ 完整注解"),e("dd",null,[e("span",{class:"gray"},"2m-AFF")]),e("dd",null,[e("span",{class:"gray"},"二称个指-感事格")])],-1),ae=e("dl",null,[e("dt",null,"Ithkuil 单词"),e("dd",null,"yagḑá"),e("dd",null,[e("span",{class:"gray"},"gḑadá")]),e("dd",null,[e("span",{class:"gray"},"agḑadahá")])],-1),ie=e("dl",null,[e("dt",null,"词类"),e("dd",null,"动词性构形词")],-1),oe=e("dl",null,[e("dt",null,"含义"),e("dd",null,"感觉好")],-1),se=e("dl",null,[e("dt",null,"注解 \\ 完整注解"),e("dd",null,[e("span",{class:"gray"},"S1.PRX"),t("-“感觉良好”-"),e("span",{class:"blue"},"OBS")]),e("dd",null,[e("span",{class:"gray"},"词干一.近限域"),t("-“~”-"),e("span",{class:"blue"},"观察据")])],-1),le=e("dl",null,[e("dt",null,"Ithkuil 单词"),e("dd",null,"li")],-1),re=e("dl",null,[e("dt",null,"词类"),e("dd",null,"指代词")],-1),de=e("dl",null,[e("dt",null,"含义"),e("dd",null,[t("我"),e("small",{class:"parnt"},"体验状态时使用")])],-1),he=e("dl",null,[e("dt",null,"注解 \\ 完整注解"),e("dd",null,[e("span",{class:"gray"},"1m-AFF")]),e("dd",null,[e("span",{class:"gray"},"一称个指-感事格")])],-1),ce=e("dl",null,[e("dt",null,"Ithkuil 单词"),e("dd",null,"wamyáu"),e("dd",null,[e("span",{class:"gray"},"myaláu")]),e("dd",null,[e("span",{class:"gray"},"amyalaháu")])],-1),me=e("dl",null,[e("dt",null,"词类"),e("dd",null,"动词性构形词")],-1),ue=e("dl",null,[e("dt",null,"含义"),e("dd",null,"谢谢")],-1),ge=e("dl",null,[e("dt",null,"注解 \\ 完整注解"),e("dd",null,[e("span",{class:"gray"},"S1"),t("-“对所提供的恩惠/荣誉/礼貌表示感谢”-"),e("span",{class:"blue"},"DEC")]),e("dd",null,[e("span",{class:"gray"},"词干一"),t("-“~”-"),e("span",{class:"blue"},"宣示语为")])],-1),pe=e("dl",null,[e("dt",null,"Ithkuil 单词"),e("dd",null,"yagḑögá"),e("dd",null,[e("span",{class:"gray"},"gḑadögá")]),e("dd",null,[e("span",{class:"gray"},"agḑadögahá")])],-1),fe=e("dl",null,[e("dt",null,"词类"),e("dd",null,"动词性构形词")],-1),ye=e("dl",null,[e("dt",null,"含义"),e("dd",null,"感觉挺好")],-1),be=e("dl",null,[e("dt",null,"注解 \\ 完整注解"),e("dd",null,[e("span",{class:"gray"},"S1.PRX"),t("-“感觉良好”-"),e("span",{class:"blue"},"“有点大程度”₁-OBS")]),e("dd",null,[e("span",{class:"gray"},"词干一.近限域"),t("-“~”-"),e("span",{class:"blue"},"“~”₁-观察据")])],-1),we=e("dl",null,[e("dt",null,"Ithkuil 单词"),e("dd",null,"wamyogáu"),e("dd",null,[e("span",{class:"gray"},"myalogáu")]),e("dd",null,[e("span",{class:"gray"},"amyalogaháu")])],-1),ve=e("dl",null,[e("dt",null,"词类"),e("dd",null,"动词性构形词")],-1),ke=e("dl",null,[e("dt",null,"含义"),e("dd",null,"非常感谢")],-1),xe=e("dl",null,[e("dt",null,"注解 \\ 完整注解"),e("dd",null,[e("span",{class:"gray"},"S1"),t("-“对所提供的恩惠/荣誉/礼节表示感谢”-"),e("span",{class:"blue"},"“大程度”₁-DEC")]),e("dd",null,[e("span",{class:"gray"},"词干一"),t("-“~”-"),e("span",{class:"blue"},"“~”₁-宣示语为")])],-1),Ie=e("dl",null,[e("dt",null,"Ithkuil 单词"),e("dd",null,"wattráu"),e("dd",null,[e("span",{class:"gray"},"ttraláu")]),e("dd",null,[e("span",{class:"gray"},"attralaháu")])],-1),_e=e("dl",null,[e("dt",null,"词类"),e("dd",null,"动词性构形词")],-1),Ae=e("dl",null,[e("dt",null,"含义"),e("dd",null,"拜拜、再见")],-1),Se=e("dl",null,[e("dt",null,"注解 \\ 完整注解"),e("dd",null,[e("span",{class:"gray"},"S1"),t("-“随意告辞”-"),e("span",{class:"blue"},"DEC")]),e("dd",null,[e("span",{class:"gray"},"词干一"),t("-“~”-"),e("span",{class:"blue"},"宣示语为")])],-1),Be=l('<h3 id="语法" tabindex="-1"><a class="header-anchor" href="#语法" aria-hidden="true">#</a> 语法</h3><h4 id="ithkuil-如何运作" tabindex="-1"><a class="header-anchor" href="#ithkuil-如何运作" aria-hidden="true">#</a> Ithkuil 如何运作？</h4><p>Ithkuil 首先是一种<small class="parnt">高度</small>黏着语，其次是一种综合语。这意味着 Ithkuil 高度依赖黏着词缀到单词来表达微妙的含义。</p><p>在开始讨论 Ithkuil 的例子之前，让我们先观察一下英语中的类似现象。</p><p>我们可以在名词上加上后缀 -ful，组成一个新的形容词，意思是「拥有很多X的性质」。除此之外，我们还可以添加后缀-ly，构成形容词的副词，意思是「以这样的方式……」</p><table><thead><tr><th>Care</th><th>Careful</th><th>Carefully</th></tr></thead><tbody><tr><td>仔细；小心；谨慎</td><td>处于一种很~的状态</td><td>以一种很~的方式</td></tr></tbody></table><p>我们可以改变单词的「词干」，同时使用相同的结构来创造 beautiful 和 beautifully。我们还可以改变这个词的「词缀」，创造出 careless、carelessly、carelessness。</p><p>我们已经可以看到用这种英语模式构建细致词汇的灵活性和潜力的力量，而这种模式甚至不为人所知。Ithkuil 将这一原则提升到了一个更高的水平。它规范化模式，从而能够表达自然语言无法比拟的微妙细节。</p><ol><li>例一：</li></ol><div style="text-align:center;"><p>yagḑ + éu</p><p>yagḑ + á</p></div><p>以上词对 <b>yagḑéu</b><small class="parnt">感觉好吗？</small>及 <b>yagḑá</b><small class="parnt">感觉好。</small>看起来非常相似，具有同样的「首部分」而「结尾不同」。而单词 <b>wattáu</b>、<b>wamyáu</b>、<b>wattráu</b> 的「结尾」相同。其含义和语法将在后面介绍。</p><ol start="2"><li>例二：</li></ol><dl><dt>yagḑá = yagḑ + á</dt><dd>感觉好。</dd></dl><dl><dt>yagḑögá = yagḑ + ög + á</dt><dd>感觉挺好。</dd></dl><dl><dt>wamyáu = wamy+ áu</dt><dd>感谢。</dd></dl><dl><dt>wamyogáu = wamy+ og + áu</dt><dd>非常感谢。</dd></dl><p>正如所见，诸如英语之类的分析语言利用孤立词<small class="parnt">在这种情况下是很好地利用</small>在句子中以适当的词序添加<small class="parnt">在这种情况下就在形容词之前</small>来扩展句子，并添加更多细节。相比之下，Ithkuil 是一种粘着语言，因此它将词缀<small class="parnt">-<b>ög</b>，有点大程度</small>出于相同的目的插入到单词内的适当位置。对于涉及「感谢」的例子也是如此。</p><p>有关如何应用词缀的更多细节将在稍后讨论。</p><h4 id="词类" tabindex="-1"><a class="header-anchor" href="#词类" aria-hidden="true">#</a> 词类</h4><p>New Ithkuil 有四种词类：动词性构形词、名词性构形词、小词、指代词。</p><ol><li><span style="text-decoration:underline;">动词性构形词</span>构成一类词，通常对应于自然人类语言中的动词。默认情况下<span style="text-decoration:underline;">动词具有尾音节重读</span><small class="parnt">倒数第一音节</small></li><li><span style="text-decoration:underline;">名词性构形词</span> 构成一类词，通常对应于自然人类语言中的名词。<span style="text-decoration:underline;">名词具有次音节重读</span><small class="parnt">倒数第二音节</small></li><li><span style="text-decoration:underline;">小词</span>是一种与构形词相关的「助手」型词类，提供有关相邻构形词的进一步语义信息。</li><li><span style="text-decoration:underline;">指代词</span>是一种与自然人类语言中的代词类似的词类，尽管其用法比其他语言中的通常代词范围更加动态和广泛。</li></ol><p>正如后续课程所展示的内容，名词性构形词和动词性构形词共享大多数形态范畴，例如功能、版本、构型、系属、限域、视界、本质和语境。此外，名词性构形词根据格而变化，而动词性构形词则根据语式和言为/言据而变化。这种区别通过重读模式来体现。通过进行一些调整，可以从一种更改为另一种。例如，词根的第一个词干 -DN- 在名词性词形变化中表示「名字」，在动词性词形变化中表示「命名」。这两种意义都不被视为更内在的、更根本的，或者是从另一种意义派生出来的。</p><p>名词和动词之所以可以作为同一语法词类在形态上派生出来，是因为 New Ithkuil 的形态语义学不认为名词和动词在认知上是完全不同的，而是认为它们是一个概念在共同基础语义连续体中的互补表现。可以将其类比于物理学中的时空概念。在这个时空连续体中，New Ithkuil 语通过将语义思想实例化为词根来形成构形词这一语法词类。然后，发话者可以选择在空间上「物化」这个构形词，使其表示一个对象或实体即名词，或者在时间上「事化」这个构形词，使其表示一个行为、事件或状态即动词。这种互补过程可以用下图描述：</p><p><img src="'+c+'" alt="" data-mode="lightmode-only" loading="lazy"><br><img src="'+m+'" alt="" data-mode="darkmode-only" loading="lazy"></p><h4 id="句法" tabindex="-1"><a class="header-anchor" href="#句法" aria-hidden="true">#</a> 句法</h4><p>Ithkuil 不依赖语序，而是依赖语法格，来标记每个单词的语义角色。除了特别强调或写作风格之外，<span style="text-decoration:underline;">Ithkuil 句子的默认语序是动词起首。</span> <sup class="footnote-ref"><a href="#footnote2">[2]</a><a class="footnote-anchor" id="footnote-ref2"></a></sup></p><p>「你好吗？」在 Ithkuil 中是<q>Yagḑéu si?</q>，字面意思是「感觉好吗，你？」。回答是「我很好」，即<q>Yagḑá li</q>，字面意思是「感觉良好，我」。</p><p>请注意，由于格范畴的原因，<q>si</q>不等于「你」。发话者需要根据情况替换格。为了说明这一点，请注意<q>Me go to the park</q><small class="parnt">我去公园</small>是不正确的英语句子，尽管<q>I</q>和<q>me</q>都是第一人称单数代词。 Ithkuil 格系统与印欧语<small class="parnt">如拉丁语、德语、俄语、印地语等</small>的格系统有着本质上的不同，这一点将在将来揭示。</p><h4 id="列位-–-形态" tabindex="-1"><a class="header-anchor" href="#列位-–-形态" aria-hidden="true">#</a> 列位 – 形态</h4><p>作为黏着语，Ithkuil 通过在音节后面添加音节来表现其语法特征。</p><p>例如，一起分解一下从课程中学到的一些单词。</p><table><thead><tr><th>列位</th><th>I</th><th>II</th><th>III</th><th>IV</th><th>V</th><th>VI</th><th>VII</th><th>VIII</th><th>IX</th><th>X</th></tr></thead><tbody><tr><td>wattáu</td><td>w</td><td>a</td><td>tt</td><td></td><td></td><td></td><td></td><td></td><td>au</td><td>(尾)</td></tr><tr><td>ttaláu</td><td></td><td></td><td>tt</td><td>a</td><td></td><td>l</td><td></td><td></td><td>au</td><td>(尾)</td></tr><tr><td>attalaháu</td><td>ʼ</td><td>a</td><td>tt</td><td>a</td><td></td><td>l</td><td></td><td>ah</td><td>au</td><td>(尾)</td></tr><tr><td>yagḑögá</td><td>y</td><td>a</td><td>gḍ</td><td></td><td></td><td></td><td>ög</td><td></td><td>a</td><td>(尾)</td></tr><tr><td>gḑadögá</td><td></td><td></td><td>gḍ</td><td>a</td><td></td><td>d</td><td>ög</td><td></td><td>a</td><td>(尾)</td></tr><tr><td>agḑadögahá</td><td>ʼ</td><td>a</td><td>gḍ</td><td>a</td><td></td><td>d</td><td>ög</td><td>ah</td><td>a</td><td>(尾)</td></tr></tbody></table><p>可注意到一些事情：</p><ol><li><strong>Ithkuil 构形词有 10 个列位</strong><small class="parnt">其中一个是重读</small></li><li>一个列位可 <ul><li>为空</li><li>填上未书写的声门塞音 ʼ<small class="parnt">仅在词首</small></li><li>填上一个辅音丛</li><li>填上元音丛</li><li>填上辅音丛+元音丛的序列</li><li>填上元音丛+辅音丛的序列</li><li>一个重读值，如(尾)指尾音节，即最后一个音节。 <ol><li>另一重读值 (次) 次音节 = 倒数第二音节</li><li>另一重读值 (前) 前音节 = 倒数第三音节</li></ol></li></ul></li><li>每个列位皆包含一致音值。列位 I 总填入辅音，列位二总填入元音，依此类推。</li></ol><p>将在以后的课程中学习每个列位传达的含义，以及如何决定将哪个元音或辅音分组到哪个位置。</p><p>可以注意到，在词汇部分，有些单词有替代形式<small class="parnt">标记为灰色</small>。在 Ithkuil 中，有时可以缩短单词<small class="parnt">更准确地说，构形词</small>，通常是在某些列位采用默认值时。</p><p>这些规则将在以后的课程中揭晓。请读者自己探索这些规则，或者暂时将它们作为单独的单词记住。</p><p>只要有可能，倾向于使用简替形式，并且优先于更容易发音的形式<small class="parnt">例如更少的音节、更少的辅音簇</small>。例如，wattau 是最容易发音的一个，因此倾向于更频繁地使用它。</p><h4 id="词根-–-列位-iii-–-形态" tabindex="-1"><a class="header-anchor" href="#词根-–-列位-iii-–-形态" aria-hidden="true">#</a> 词根 – 列位 III – 形态</h4><p>**列位 III 乃构形词之词根所在 **</p><p>每个词根由辅音<small class="parnt">丛，最多五个</small>组成。</p><p>本节课已学到以下词根：</p><ol><li>-tt-，意为“招呼/问候/介绍”</li><li>-gḍ-，意为“生理安康感”</li><li>-my-，意为“感谢/感恩”</li><li>-ttr-，意为“告辞/道别/诀别”</li></ol><p>词根代表了一个构形词的通常概念，它包含了几个相关的动作、概念或对象。可见「你好」位于词根-tt-「招呼/问候/介绍」之下但它并不是唯一可以从词根派生的单词。事实上，招呼、自我介绍、问候语等，都可以从同根而生。</p><p>我们将在第 2 课中学习从词根派生单词的规则<small class="parnt">所谓的 4 个词干和 4 个详述</small>。</p><h4 id="语为与言据-–-列位-ix-–-形态" tabindex="-1"><a class="header-anchor" href="#语为与言据-–-列位-ix-–-形态" aria-hidden="true">#</a> 语为与言据 – 列位 IX – 形态</h4><p>一起再看一遍对话，并关注于构形词的结尾元音。</p><p>A: Wattáu.</p><p>B: Wattáu.</p><p>A: Yagḑéu si?</p><p>B: Yagḑá li. Wamyáu. Yagḑéu si?</p><p>A: Yagḑögá. Wamyogáu.</p><p>B: Wattráu.</p><p>A: Wattráu.</p><p>可见，在这段对话的所有句子中，</p><p>1.<small class="parnt">是/否</small>问题由 éu 结尾。<br> 2. 对问题的肯定回答由 á 结尾。<br> 3. 其他构形词<small class="parnt">例如嗨！谢谢！再见！</small>以 áu 结尾。</p><p><strong>列位 IX<small class="parnt">填入尾音节重读</small>指示语为</strong></p>',57),Ne=e("hr",{class:"footnotes-sep"},null,-1),Te={class:"footnotes"},Ce={class:"footnotes-list"},Ee={id:"footnote1",class:"footnote-item"},je={href:"http://ithkuil.net",target:"_blank",rel:"noopener noreferrer"},Ve=e("a",{href:"#footnote-ref1",class:"footnote-backref"},"↩︎",-1),Pe={id:"footnote2",class:"footnote-item"},De=e("small",{class:"parnt"},"已经有太多的东西需要学习，并且本课程中没有示例说明替代语序",-1),qe={href:"http://ithkuil.net",target:"_blank",rel:"noopener noreferrer"},We=e("a",{href:"#footnote-ref2",class:"footnote-backref"},"↩︎",-1);function Fe(Me,Oe){const r=s("tooltip"),d=s("Tabs"),h=s("ExternalLinkIcon");return g(),p("div",null,[I,e("p",null,[t("人造语言，没有其母语人士，也没有现实的沉浸式学习环境。与世界语等现有自然语言关系更密切的造语不同，国际语可以通过"),o(r,{label:"reglossing strategy"},{default:n(()=>[t("重解策略")]),_:1}),t("来学习。例如，"),_,A,t("可以是重新注解成「第一人称.单数.主格 系词.现在简单时态.一单 不定冠词.单数 学生.单数」并找到每个单词在目标语言的翻译"),S,t("，可能会有一定程度的句法变化"),B,t("。然而，由于其超级复杂且具有与现有自然语言不同的语法结构，类似的方法很难用于学习 Ithkuil。")]),e("p",null,[t("由于语言习得包括寻找模式和内化模式，因此用不同的词汇进行联想和造出类似的句子似乎是一个很好的做法。它有几个好处。首先，它帮助学习者识别和记忆模式。事实上，由于存在如此多的语法特征，对每个单词都进行思考是不现实的，因此识别和内化一些「"),o(r,{label:"anchor patterns"},{default:n(()=>[t("锚定模式")]),_:1}),t("」并只在必要时对这些「锚定模式」进行调整会更容易。它有助于扩大词汇量。")]),N,o(d,{id:"472",data:[{id:"原文"},{id:"译文"}]},{title0:n(({value:a,isActive:i})=>[t("原文")]),title1:n(({value:a,isActive:i})=>[t("译文")]),tab0:n(({value:a,isActive:i})=>[T,C,E,j,V,P,D]),tab1:n(({value:a,isActive:i})=>[q,W,F,M,O,R,L]),_:1}),X,H,o(d,{id:"526",data:[{id:"1"},{id:"2"},{id:"3"},{id:"4"},{id:"5"},{id:"6"},{id:"7"},{id:"8"},{id:"1"}]},{title0:n(({value:a,isActive:i})=>[t("1")]),title1:n(({value:a,isActive:i})=>[t("2")]),title2:n(({value:a,isActive:i})=>[t("3")]),title3:n(({value:a,isActive:i})=>[t("4")]),title4:n(({value:a,isActive:i})=>[t("5")]),title5:n(({value:a,isActive:i})=>[t("6")]),title6:n(({value:a,isActive:i})=>[t("7")]),title7:n(({value:a,isActive:i})=>[t("8")]),title8:n(({value:a,isActive:i})=>[t("1")]),tab0:n(({value:a,isActive:i})=>[Q,z,Y,U]),tab1:n(({value:a,isActive:i})=>[G,J,K,Z]),tab2:n(({value:a,isActive:i})=>[$,ee,te,ne]),tab3:n(({value:a,isActive:i})=>[ae,ie,oe,se]),tab4:n(({value:a,isActive:i})=>[le,re,de,he]),tab5:n(({value:a,isActive:i})=>[ce,me,ue,ge]),tab6:n(({value:a,isActive:i})=>[pe,fe,ye,be]),tab7:n(({value:a,isActive:i})=>[we,ve,ke,xe]),tab8:n(({value:a,isActive:i})=>[Ie,_e,Ae,Se]),_:1}),Be,f(` 本节课构形词的结尾表示所谓**语为**的概念，它指由一种由说话者所作的「语言行为」，即话语
...
Q7. True or False. A yes/no question is formed by inflecting the verb to VER Verificative, marked with éu
...
Q : A sentence like “hi”, i.e. “A greeting hereby happens”. Is it functional?
...
Conclusion on EXS vs FNC context :
...
myailëiháu: S1-“offering gratitude for a favor/honor/courtesy performed”-FNC-CPL-DEC
...
lu = I (who do an action to myself, or decide to make myself do sth)
...
**The DIR directive illocution indicates an order**. It is marked <b>ai</b> in slot IX. In the dialogue we see
...
None, similarity N/A => (explicitly) no purpose

US => single similar purpose, correpond to current ASO

UD => single different purpose, correspond to current COA

UF => single fuzzy purpose

	tell-tale

verbal formative : ultimate stress, indicating slot IX for illocution/validation

nominal formative : penultimate stress, indicating slot IX for case
...
almost always use PRC version.

use more adjunct.

Q: how many adjuncts can be applied to a formative?
 `),Ne,e("section",Te,[e("ol",Ce,[e("li",Ee,[e("p",null,[t("引用自 "),e("a",je,[t("ithkuil.net"),o(h)]),t(),Ve])]),e("li",Pe,[e("p",null,[t("我知道语序与主题·评论·焦点相关。然而，为实现课程的目的"),De,t("。此外，在 "),e("a",qe,[t("ithkuil.net"),o(h)]),t(" 中找到的 Ithkuil 示例中几乎完全使用事实上的动词起首。 "),We])])])])])}const He=u(x,[["render",Fe],["__file","cl.html.vue"]]);export{He as default};
