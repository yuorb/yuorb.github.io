...
<details>
    ...
    <li><tooltip label="to decrease">减少</tooltip> → <tooltip label="minimize">最小化</tooltip></li>
    ...
    <li><tooltip label="to shrink">收缩</tooltip> → <tooltip label="miniaturize">小型化</tooltip></li>
    ...
    <li><tooltip label="to darken">变暗</tooltip> → <tooltip label="to make dark">暗</tooltip></li>
