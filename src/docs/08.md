...
The `Cp` affix of these adjuncts may be used in the C₁ Slot of a Single--, Dual-, or Combination Referential (see [Sec. 9.5](http://ithkuil.net/newithkuil_09_referentials.htm#Sec9_5)). When so used, the `Cp` affix must be preceded by a word-initial epenthetic vowel to avoid the adjunct being mistaken for a modular adjunct or a concatenated formative. See [Sec. 9.6](http://ithkuil.net/newithkuil_09_referentials.htm#Sec9_6) for the specific rules involved.
