...
外部音渡规则：当一个以辅音形式结尾的词（即，无论是单个辅音还是多个辅音组合）在同一呼吸群中，紧接着一个以辅音形式开头的词时，通常需要在第一个词的末尾或第二个词的开头添加一个元音，以避免混淆词尾和/或词首辅音属于哪个词。这通过填充适当的词首和/或词尾元音性列位（例如，列位 II，列位 IX）来实现。

注意：至于言域小词，由于外部音渡规则不适用于外来语/词，所以在发出名称/词语后，在 <abbr>CAR</abbr> 小词 hü 或 <abbr>SPF</abbr> 尾小词 hiu 之前插入一个停顿，或者用低平调读专有名词/短语中最后一个词（从重读音节开始）。
