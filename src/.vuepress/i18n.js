...
export const I18N_DICTIONARY = {
  ...
  sandbox: {
    '/': {
      placeholder: '输入 Ithkuil 词汇',
      scriptTitle: 'Ithkuil 原生书写文字',
      generateScriptBtn: '绘制矢量图',
    ...
    '/en/': {
      placeholder: 'Enter Ithkuil word',
      scriptTitle: 'Native Block Script Rendering',
      generateScriptBtn: 'Render SVG',
    ...
    '/fr/': {
      placeholder: 'Entrez un mot Ithkuil',
      scriptTitle: 'Écriture native en bloc',
    ...
    '/ja/': {
      placeholder: 'Ithkuil 語彙を入力',
      scriptTitle: 'Ithkuil 固有文字',
      generateScriptBtn: 'SVG を生成',
  ...
  numconverter: {
    '/': {
      ...
      msgTooLong: '数字太长啦，请控制在 64 位以内哦 (・ω・)ノ',
    ...
    '/en/': {
      ...
      msgTooLong: 'Too long! Please keep it within 64 digits (・ω・)ノ',
    ...
    '/ja/': {
      ...
      msgTooLong: '長すぎるよ！64桁以内に抑えてね (・ω・)ノ',
    ...
    '/fr/': {
      ...
      msgTooLong: 'Trop long ! Reste sous les 64 chiffres stp (・ω・)ノ',
