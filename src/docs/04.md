...
当场格通过构形词列位 IX 中`Vc`词缀 -ie’（实现为 -i’e）所标记。它作为位格的一种变体，用于表示某事发生/存在/处于某事物的在场处。然而，这样的功能意味着当场格可以表达对事件/状态/行为/发生/情况的模糊或外部确定的非因果（或潜在因果）关系。当场格标记的参与方与情况相关或参与其中，然而，参与方式模糊、未定义，或者留给受话者想象/推测。
...
<div class="indent">
    ...
    <dl class="gloss">
      ...
      <dd>联:‘clown’-MDS-COR-主:’path’-RPS-NAV</dd>
    </dl>
