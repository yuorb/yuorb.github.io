...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- | ----------------------------------- | --------------------------------------------------------------------- | ------------------------------------------------------ | -------------------------------------------------------------------- |
| • Relation• Concatenation Status• Stem• Specification• Function• Context• Version• `Ca` (Affiliation, Configuration, Plexity, Perspective, Extension, Essence) | `Cr`Main Root | `Cs`(Slot V) | `Cs`(Slot VII)[character is laterally rotated 180 degrees] | • Valence• Phase• Effect• Aspect• Level | `VcVk` plus Mood and/or Case-Scope |
