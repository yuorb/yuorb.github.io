...
<div class="indent">
    ...
    <dl class="gloss">
      <dt><del>itrulalžói</del><ins>itrutļalžá</ins></dt>
      <dd>Stem.2/CPT-“approach”-<ins>DYN-RPV-</ins>OBG₁/1-<del>POT</del><ins>OBS</ins></dd>
    </dl>
    <dl class="gloss">
      <dt>kaʼi</dt>
      <dd>pa/BEN-ACT</dd>
...
::: tip Revisorʼs Note 💡 Scope and Shortcut Explanation 

Note the formative **wairţtuʼzwu** in this sentence. Without the glottal stop (as in the original **wairţtuzwu**), the **IND** case accessor would scope over the Agglomerative perspective (**G**), meaning “the one who does some studying.” To precisely convey “the students (at least one of those who study),” a glottal stop (**ʼ**) is inserted into this formative. This shortcut effectively inverts the semantic scope between the Slot V affix and the case accessor, ensuring that the Agglomerative perspective properly scopes over the case accessor. 
