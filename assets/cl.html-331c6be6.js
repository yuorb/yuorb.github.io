...
Q: how many adjuncts can be applied to a formative?
 `),Ne,e("section",Te,[e("ol",Ee,[e("li",Ce,[e("p",null,[t("引用自 "),e("a",je,[t("ithkuil.net"),o(h)]),t(),Ve])]),e("li",Pe,[e("p",null,[t("我知道语序与主题·评论·焦点相关。然而，为实现课程的目的"),De,t("。此外，在 "),e("a",qe,[t("ithkuil.net"),o(h)]),t(" 中找到的 Ithkuil 示例中几乎完全使用事实上的动词起首。 "),We])])])])])}const He=u(x,[["render",Fe],["__file","cl.html.vue"]]);export{He as default};
